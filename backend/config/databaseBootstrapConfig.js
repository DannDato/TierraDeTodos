export const FK_DEFINITIONS = [
  ...
  { name: 'fk_user_stats_userId', table: 'user_stats', fields: ['userId'], referencedTable: 'Users', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
  { name: 'fk_user_stats_statDefinitionId', table: 'user_stats', fields: ['statDefinitionId'], referencedTable: 'stat_definitions', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
  { name: 'fk_achievements_statDefinitionId', table: 'achievements', fields: ['statDefinitionId'], referencedTable: 'stat_definitions', referencedFields: ['id'], options: { onDelete: 'SET NULL' } },
  { name: 'fk_achievements_prizeEmblemId', table: 'achievements', fields: ['prizeEmblemId'], referencedTable: 'emblems', referencedFields: ['id'], options: { onDelete: 'SET NULL' } },
  { name: 'fk_user_achievements_userId', table: 'user_achievements', fields: ['userId'], referencedTable: 'Users', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
  { name: 'fk_user_achievements_achievementId', table: 'user_achievements', fields: ['achievementId'], referencedTable: 'achievements', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
  { name: 'fk_user_notifications_userId', table: 'user_notifications', fields: ['userId'], referencedTable: 'Users', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
  { name: 'fk_user_notifications_notificationId', table: 'user_notifications', fields: ['notificationId'], referencedTable: 'notifications', referencedFields: ['id'], options: { onDelete: 'CASCADE' } },
