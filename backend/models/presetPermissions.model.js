export default (sequelize, DataTypes) => {
  ...
  PresetPermissions.seed = async () => {
    const seedPresetPermissions = [
      ...
      { role: 'SUPER-ADMIN', permissionKey: 'system_information.view', active: true },
      { role: 'SUPER-ADMIN', permissionKey: 'system_information.gest', active: true },
      ...
      { role: 'ADMIN', permissionKey: 'system_information.view', active: true },
      { role: 'ADMIN', permissionKey: 'system_information.gest', active: true },
